...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/yellow-bush-3289#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-bush-3289
```

A live public deployment of this template is available at [https://yellow-bush-3289.templates.workers.dev](https://yellow-bush-3289.templates.workers.dev)
